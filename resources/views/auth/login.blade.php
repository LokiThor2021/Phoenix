...
@endsection
@section('content')
    <main class="m-auto max-w-lg p-2 leading-loose">
        ...
        <form role="form" action="{{ \route('login') }}" method="POST">
            <fieldset>
                <div class="flex flex-col">
                    <div class="flex relative">
                        ...
                        <input type="text"
                               name="username"
                               id="username"
                               class=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-desi-gold focus:border-transparent"
                               value="{{old('username')}}"
                ...
                <div class="flex flex-col pt-4 mb-1">
                    <div class="flex relative">
                         <span class=" inline-flex  items-center px-3 border-t bg-white border-l border-b  border-gray-300 text-gray-500 shadow-sm text-sm">
                            <svg width="15"
                                 height="15"
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <span class="text-sx text-center text-white  dark:text-gray-400">Rest Your <a class="hover:underline decoration-desi-gold" href="{{\route('password.request')}}">Password</a> / <a class="hover:underline decoration-desi-gold" href="{{route('username.request')}}">Username</a></span>
            <span class="w-1/5 border-b dark:border-gray-400 lg:w-1/5"></span>
        </div>
        <div class="flex items-center mt-6 -mx-2">
            <a type="button" href="{{\env('DISCORD_LINK','#')}}"
               class="flex items-center justify-center w-full px-6 py-2 .mx-2 text-sm font-medium text-white transition-colors duration-200 transform bg-discord  hover:bg-blue-400 focus:bg-blue-400 focus:outline-none">
